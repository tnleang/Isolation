...
private:
    ...
    currentMovedNode maxValue(vector<pair<int, int>> &legalMoves, pair<int, int> player_pos, const int &depth, int &alpha, int &beta, const int &highest_score, const pair<int, int> &best_move);
    currentMovedNode minValue(vector<pair<int, int>> &legalMoves, pair<int, int> player_pos, const int &depth, int &alpha, int &beta, const int &lowest_score, const pair<int, int> &best_move);
